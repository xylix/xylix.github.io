---
title: Useful vices and dubious virtues
...
Nate Soares talks about [desperation](https://mindingourway.com/desperation/), [recklessness](https://mindingourway.com/recklessness/), [defiance](https://mindingourway.com/defiance/), naming them the _three dubious virtues_.
...
In a way these exact patterns of thinking are directionally opposite from Desperation. And actually my current top theory is that they were formed as defence mechanisms against desperation - there was a time when I figured I often went in the wrong direction when I fully trusted myself and so I stopped.
But I think the time for this is over. 
TODO: _It is time to answer the Phoenix' call._
...
I think on a gut level I have believed that the fact that saving lives, working on important topics, is important, for years. But I was also holding a contradiction - the way I'd describe it is I held a belief of "If I can save multiple lives per year by working on the right topic, making the right decisions, that implies that I _must_ burn as much of myself as I can to get that work done, since there is no philosophical reason why my life would be worth more than anyone else's." I now know that I was wrong - and we will elaborate on it more under self-preservation. 

I think the short instrumental case for why this isn't true is "You can't do your best work if you go too far _under your happy price_.". This has some implications, one of which is that lifestyle creep is very real in a way.
TODO: link my "working under my happy price" text when I do one.

The philosophical case is more so just plain - "_You deserve your happy price and so you are allowed to demand the world for it._". Of course, if your values are truly selfless, maybe your happy price is "Being able to work on the most important problems of the world.". I am not this selfless. My happy price consists of:
- Economic safety and reasonable healthcare
TODO: could refer to Maitimo's stance on Axis v Heaven here
...
One observation here is: These are actually conditions for how I think and work the best. And, ironically, a big part of my happy price is _getting to think well_. It is one of the most enjoyable parts of life, after all, and one reason why I quite like work, when the work is aligned with me.
...
> The second dubious virtue is recklessness. As with desperation, there are many bad ways to be reckless. 
> ...
...
> I get a lot of questions from people about how cautious they should be as they make changes in their lives. If they remove their guilt motivation, will they be able to do anything at all?
> ...
...
I quite enjoy _fake staring_ at the darkness of the world. I find great entertainment in melancholic fiction.
...
One way I think of defiance is as the opposing force to [_compliance_](/blog/forgiveness-not-permission). Not being burdened, tied down, merged into expectations placed onto you.
...
TODO: refer to https://wiki.c2.com/?LazinessImpatienceHubris for how laziness is a virtue in a programmer
...
Cold-takes' focus on specifically vices for [_wicked problems_](https://en.wikipedia.org/wiki/Wicked_problem) leads to a bit of a different approach;
...
The approach Karnofsky presents seems like a combination of 80-20 optimization and admitting that humans (especially _hubristic_ humans) often set goals that are unreachable or inefficient to reach.
...
This is again a classic form of the applied 80/20 and also I think one of the lessons that is straight out applicable to software engineering. "premature optimization is the root of all evil.", and all that. Aim for the point in the [quality line](https://mindingourway.com/half-assing-it-with-everything-youve-got/) that is exactly enough for your goal, and no more.

TODO: consider as footnotes?
NOTE: The questions in this manner that I have personally wasted time on have often related to questions around "What is the best programming language?" or "Are typed programming languages better than non-typed ones?"

NOTE: I have pondered the question of "Minimum viable philosophy" at times - is it workable? Why does philosophy seem allergic to drawing explicit tradeoffs 80/20 style?

TODO: unify my programmer-insight, perhaps quote Codeless Code, and Karnofsky's virtuous vices into some coherent end-paragraph for the section
...
I already talked about happy prices, under _Desperation_. So let's get back to it.
...
## Where my natural strengths lay, and how I suppress them
